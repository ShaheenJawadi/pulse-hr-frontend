...
const AttendanceByDeP = () => {
    ...
    const series =[
      ...
      const options:ApexOptions={
        ...
        colors: ['var(--mui-palette-primary-mainOpacity)', 'var(--mui-palette-error-mainOpacity)', 'var(--mui-palette-warning-mainOpacity)','var(--mui-palette-primary-main)', 'var(--mui-palette-error-main)', 'var(--mui-palette-warning-main)'],
        yaxis: {
          max: 45,
          labels: {
            formatter: (val) => val
      ...
      return (
        <Card>
          <CardHeader title="Suivi des départements" subheader="Hier vs Aujourd'hui" />
          <CardContent>
            <AppReactApexCharts
              type="bar"
              height={400}
